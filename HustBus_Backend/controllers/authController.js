...
if (!JWT_SECRET) {
  throw new Error(
    "JWT_SECRET is not set. Please configure the environment variable."
  );
}

// JWT_REFRESH_SECRET validation
// Note: If not set, will fallback to JWT_SECRET (acceptable for development)
// For production, it's recommended to use a separate secret for refresh tokens
